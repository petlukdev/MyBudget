...
export default function DashboardCard({ title, value = 0 } : DashboardCardProps) {
    
    const { base, convert} = useCurrency();
    value = convert(value, Currency.EUR, base);
    
    return (
        <div className="flex flex-col justify-center items-center bg-white rounded-lg shadow-lg p-4">
